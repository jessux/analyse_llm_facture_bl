...
const MOCK_BONS: BonLivraison[] = [
  {
    numero_bon_livraison: "BL-001",
    nom_fournisseur: "SYSCO",
    date_livraison: "2024-02-28",
    montant_total: 2400.0,
    numero_facture_rattachee: "FAC-2024-001",
    fichier_source: "bl_sysco_001.pdf",
  },
  {
    numero_bon_livraison: "BL-002",
    nom_fournisseur: "SYSCO",
    date_livraison: "2024-03-01",
    montant_total: 2420.5,
    numero_facture_rattachee: "FAC-2024-001",
    fichier_source: "bl_sysco_002.pdf",
  },
  {
    numero_bon_livraison: "BL-010",
    nom_fournisseur: "AMBELYS",
    date_livraison: "2024-03-04",
    montant_total: 1340.0,
    numero_facture_rattachee: "FAC-2024-002",
    fichier_source: "bl_ambelys_010.pdf",
  },
  {
    numero_bon_livraison: "BL-020",
    nom_fournisseur: "TERREAZUR",
    date_livraison: "2024-03-09",
    montant_total: null,
    numero_facture_rattachee: null,
    fichier_source: "bl_terreazur_020.pdf",
  },
];
...
export default function TableauBonsLivraison({ data = MOCK_BONS }: { data?: BonLivraison[] }) {
